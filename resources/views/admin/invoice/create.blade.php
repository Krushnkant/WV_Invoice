                    ...
                    <tbody><tr>
                        <td>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-12">
                                    <input class="form-control custom_date_picker" type="text" id="invoice_date" name="invoice_date" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" value="{{ date("Y-m-d") }}">
